...
<head>
    ...
    <title id="edit_derangement_title">Edit Derangement</title>
...
<body>
    @include('sidebar')
    <div class="content">
        <h1 id="edit_derangement_heading">Edit Derangement</h1>
        @if ($errors->any())
        ...
        @endif
        <form id="editForm" action="{{ route('derangement.update', $derangement->ID_Derangement) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <p id="modal_text">Do you really want to edit this derangement?</p>

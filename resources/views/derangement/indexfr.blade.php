...
<body>
    ...
    <div class="content"> 
        ...
        <form action="{{ route('derangement.indexfr') }}" method="GET"></form>

        <form action="{{ route('derangement.filterfr') }}" method="GET">
            <label for="start_date" id="start_date_label">Date debut:</label>
            <input type="text" id="start_date" name="start_date" value="{{ request('start_date') }}" autocomplete="off">
            <label for="end_date" id="end_date_label">Date fin:</label>
            ...
            <a href="{{ route('derangement.indexfr') }}" class="btn btn-primary" id="reset_button">Réinitialiser</a>
        </form>
            ...
            <table id="derangementsTable" class="display">
                <thead>
                    <tr>
                        ...
                        <th id="th_status">Statue derang</th>
                        ...
                        <th id="th_created_at">Créé à</th>
                        <th id="th_edit">Modifier</th>
                        <th id="th_delete">Supprimer</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($derangement as $derangements)
                        <tr>
                            ...
                            <td><a class="btn" href="{{ route('derangement.editfr', $derangements->ID_Derangement) }}" id="edit_link">Modifier</a></td>
                            <td>
                                <form action="{{ route('derangement.destroyfr', $derangements->ID_Derangement) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn" type="submit" id="delete_button">Supprimer</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST">
                ...
                <div>
                    <button type="submit" id="yes_button">Oui</button>
                </div>
            </form>
        </div>
    </div>

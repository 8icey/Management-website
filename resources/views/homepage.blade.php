...
<body>
    ...
    <div class="content">
        <h1>Algerie Telecom Statistics</h1>
        <div class="category-container">
            <h2 class="category-title" id="title_demands">Demands Stats:</h2>
            <div class="demande-item">
                <h3 id="title_total_demands">Total Demands: {{ $totalDemands }}</h3>
            ...
            <div class="demande-item">
                <h3 id="title_demands_not_done">Demands not done: {{ $demandsNotDone }}</h3>
                <div class="chart-container">
                    <canvas id="demandsNotDoneChart"></canvas>
                </div>
            </div>
            <div class="demande-item">
                <h3 id="title_demands_done">Demands done:  {{ $demandsDone }}</h3>
                <div class="chart-container">
        ...
        <div class="breakdown-container">
            ...
            <div class="breakdown-item">
                ...
                <h3 id="title_total_breakdowns_plotly">Total breakdowns: {{ $totalBreakdowns }}</h3>
                <div class="chart-container">
            ...
            <div class="breakdown-item">
                <h3 id="title_total_breakdowns_plotly">Breakdowns Done: {{ $derangementsDone }}</h3>
            ...
            <div class="breakdown-item">
                <h3 id="title_total_breakdowns_plotly">Breakdowns Not Done: {{ $derangementsNotDone }}</h3>
            ...
            <div class="breakdown-item">
                <h3 id="title_total_breakdowns_plotly">Breakdown Ratio: {{ $ratioDerangement }}</h3>
        ...
        <div class="wilaya-container">
            <div class="bywilaya-item">
                <h3 id="title_dots_wilaya_plotly">Dots by Wilaya:</h3>
  ...
  @endphp
      @if($user && $user->Role !== 'dot') 
            <div class="bywilaya-item">
                <h3 id="title_admins_wilaya_plotly">Admins by Wilaya:</h3>
...
<div class="add">
        <h1 >Download Stat Details:</h1>
        <button class="btn" id="downloadDetails">Download</button>
    </div></div>
    ...
    <script>
        ...
        var plotlyTotalBreakdowns = {
            ...
            labels: ['Total Breakdowns'], // Labels for the chart
            type: 'pie'
        };
        ...
        var plotlyderangementsNotDone = {
            ...
            labels: ['Breakdowns Not Done'], // Labels for the chart
            type: 'pie',
            marker: {
            colors: [
        ...
        var plotlyRatioBreakdowns = {
            ...
            labels: ['Ratio Breakdowns'], // Labels for the chart
            type: 'pie',
            marker: {
        colors: [

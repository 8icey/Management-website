...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <div class="iocn-link">
          <a href="{{ route('demande.adslfr') }}">
            <i class='bx bx-collection' ></i>
            <span class="link_name">Demande</span>
          </a>
          <i class='bx bxs-chevron-down arrow' ></i>
        </div>
        <ul class="sub-menu">
          {{-- <li><a class="link_name" href="#">Demande</a></li> --}}
            <li><a href="{{ route('demande.adslfr') }}">Adsl</a></li>
          <li><a href="{{ route('demande.fibrefr') }}">Fibre</a></li>
          <li><a href="{{ route('demande.quatregfr') }}">4G</a></li>
          <li><a href="{{ route('demande.fixefr') }}">Fixe</a></li>
        </ul>
      </li>
      <li>
        <a href="{{ route('derangement.indexfr') }}">
          {{-- <i class='bx bx-pie-chart-alt-2' ></i> --}}
          <i class='bx bx-error' ></i>
          <span class="link_name">Derangement</span>
        </a>
      </li>
  ...
  @endphp
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a href="{{ route('dot.indexfr') }}">liste Dot</a></li>
          <li><a href="{{ route('dot.createfr') }}">créer Dot</a></li>
        </ul>
      </li>
      @endif
      <li>
        <a href="{{ route('settingsfr') }}">
          <i class='bx bx-cog' ></i>

...
<body>
    ...
    <div class="content">   
        ...
        @endif
        <form action="{{ route('dot.filter') }}" method="GET">
            <label for="start_date" id="strtdt">Start Date:</label>
            ...
            <a href="{{ route('dot.index') }}" class="btn btn-primary">Reset</a>
        </form>

        <form action="{{ route('dot.index') }}" method="GET"></form>
        <table  id="dotTable">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                @foreach($users as $user)
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="{{ route('dot.edit', $user->ID_user) }}">Edit</a></td>
                            <td> <form action="{{ route('dot.destroy', $user->ID_user) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')

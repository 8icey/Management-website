...
<body>
    ...
    <div class="content">   
        ...
        @endif
        <form id="editForm" action="{{ route('dot.updatefr', $dot->ID_user) }}" method="POST">
            @csrf
            @method('PUT')
            {{-- <div>
            ...
            <div>
                <label for="Nom_user">Surname</label>
                <input type="text" name="Nom_user" value="{{ $dot->Nom_user }}" required>
            </div>
            <div>
                <label for="Prenom_user">Name</label>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <p id="modal_text">Voulez-vous vraiment modifier dot?</p>

...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('demande.adslfr') }}" method="GET"></form>
        <form action="{{ route('demande.filterafr') }}" method="GET">
            ...
            <a href="{{ route('demande.adslfr') }}" class="btn" style="text-decoration: none">Réinitialiser</a>
        </form>

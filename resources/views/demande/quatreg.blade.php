...
<body>
    ...
    <div class="content">  
        ...
        <form action="{{ route('demande.quatreg') }}" method="GET"></form>
        <form action="{{ route('demande.filterq') }}" method="GET">
            ...
            <a href="{{ route('demande.quatreg') }}" class="btn btn-primary">Reset</a>

...
<!DOCTYPE html>
        ...
        <head>
          ...
          <title>Index Demande Fibre</title>
...
#demandeTable thead th {
    /* background-color: #8f3c3c; Light gray background for table header */
...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('demande.fibre') }}" method="GET"></form>
        <form action="{{ route('demande.filterfb') }}" method="GET">
            ...
            <button type="submit" class="btn" id="filter_button">Filterr</button>
            <a href="{{ route('demande.fibre') }}" class="btn">Reset</a>
        </form>
        <div>
            <table id="demandeTableFIBRE" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>ID Demande</th>
                ...
                <tbody>
                    @foreach($demandefibres as $demande)
                        <tr>
                            ...
                            <td><a class="btn" href="{{ route('demande.edit', $demande->ID_demande) }}">Edit</a></td>
                            <td>
                                <form action="{{ route('demande.destroy', $demande->ID_demande) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" name="Type_demande" value="fibre">

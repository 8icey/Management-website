...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('demande.fixefr') }}" method="GET"></form>
        <form action="{{ route('demande.filterfxfr') }}" method="GET">
            ...
            <a href="{{ route('demande.fixefr') }}" class="btn btn-primary">Réinitialiser</a>
        </form>
        <div>

...
<head>
    ...
    <title>Index Demande Fixe</title>
...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('demande.fixe') }}" method="GET"></form>
        <form action="{{ route('demande.filterfx') }}" method="GET">
            ...
            <a href="{{ route('demande.fixe') }}" class="btn btn-primary">Reset</a>
        </form>
        <div>
            <table id="demandeTableFIXE" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>ID demande</th>
                ...
                <tbody>
                    @foreach($demandefixes as $demande)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('demande.destroy', $demande->ID_demande) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" name="Type_demande" value="fixe">

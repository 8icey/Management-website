...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('demande.adsl') }}" method="GET"></form>
        <form action="{{ route('demande.filtera') }}" method="GET">
            ...
            <button type="submit" class="btn" id="filter_button">Filtrer</button>
            <a href="{{ route('demande.adsl') }}" class="btn" style="text-decoration: none">Reset</a>
        </form>

        <div>
            <table id="demandeTable" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>ID Request</th>
                ...
                <tbody>
                    @foreach($demandeadsls as $demande)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('demande.destroy', $demande->ID_demande) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" name="Type_demande" value="adsl">

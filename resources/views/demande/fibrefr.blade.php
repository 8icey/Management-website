...
<body>
    ...
    <div class="content">
        ...
        <form action="{{ route('demande.fibrefr') }}" method="GET"></form>
        <form action="{{ route('demande.filterfbfr') }}" method="GET">
            ...
            <a href="{{ route('demande.fibrefr') }}" class="btn">Réinitialiser</a>
        </form>
        <div>

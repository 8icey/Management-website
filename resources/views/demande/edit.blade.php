...
<body>
    ...
    <div class="content">
        ...
        @endif
        <form id="editForm" action="{{ route('demande.update', $demande->ID_demande) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
                <label for="Status_demande" id="status_label">Status demande</label>
                <input type="text" name="Status_demande" value="{{$demande->Status_demande}}" maxlength="10" pattern="[A-Za-z]+" required>
            </div>
            <div>
                <button type="button" onclick="showModal()" id="btnupdate" >Update demande</button>
            </div>
        </form>
    </div>
    @include('footer') 
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <p id="modal_text">Do you really want to edit this demande?</p>
